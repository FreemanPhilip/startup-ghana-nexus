    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-hidden min-w-0">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          {!["messages", "profile", "startup-profile", "public-profile", "settings"].includes(activeTab) && <DashboardRightSidebar role="investor" onNavigate={handleTabChange} onViewProfile={handleViewProfile} />}
        </div>
      </div>
    </div>
  );
