    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-hidden min-w-0">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          {!["messages", "groups", "profile", "my-startups", "startup-profile", "mentor-briefing", "my-sessions", "public-profile", "settings"].includes(activeTab) && (activeTab === "investors" ? <InvestorRightSidebar onViewInvestor={() => handleTabChange("investors")} /> : <DashboardRightSidebar role="startup_founder" onNavigate={handleTabChange} onViewProfile={handleViewProfile} />)}
        </div>
      </div>
