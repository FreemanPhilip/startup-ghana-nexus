...
const HeroSection = () => {
  return (
    <section className="relative min-h-[90vh] overflow-hidden bg-gradient-hero pt-16">
      {/* Background image */}
      ...
      <div className="container relative z-10 flex min-h-[90vh] flex-col items-center justify-center py-20 text-center">
        <motion.div
          ...
          className="mb-6 inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-1.5 text-sm font-medium text-gold-light"
        >
        ...
        <motion.h1
          ...
          className="max-w-4xl font-display text-4xl font-bold leading-tight tracking-tight text-primary-foreground sm:text-5xl md:text-6xl lg:text-7xl"
        >
          Connect. Build.{" "}
        ...
        <motion.p
          ...
          className="mt-6 max-w-2xl text-lg text-primary-foreground/70 sm:text-xl"
        >
        ...
        >
          {[
            ...
            <div key={stat.label} className="flex flex-col items-center gap-1">
              ...
              <span className="text-xs text-primary-foreground/50 sm:text-sm">
                {stat.label}
              </span>
            </div>
          ))}
