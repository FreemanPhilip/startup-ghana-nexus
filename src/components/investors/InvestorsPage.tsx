...
const demoInvestors: InvestorData[] = [
  { id: "1", name: "Accra Venture Partners", description: "Early-stage VC focusing on FinTech and e-commerce...", tags: ["FinTech", "Seed", "B2B"], avgTicket: "$150k", matchPercent: 98, status: "Active Now", icon: "building" },
  { id: "2", name: "GCF Impact Fund", description: "Driving sustainable growth through Series A investments...", tags: ["CleanTech", "Series A", "Impact"], avgTicket: "$750k", matchPercent: 85, status: "Replied in 2h", icon: "globe" },
  { id: "3", name: "Pan-African Angels", description: "Strategic angel network connecting diaspora capital t...", tags: ["Any Sector", "Pre-Seed", "Equity"], avgTicket: "$25k", matchPercent: 92, status: "Top Rated", icon: "users" },
  { id: "4", name: "Kumasi Tech Capital", description: "Dedicated to fostering the tech ecosystem in the Ashanti...", tags: ["Hardware", "Seed", "SaaS"], avgTicket: "$100k", matchPercent: 72, status: "New Fund", icon: "briefcase" },
  { id: "5", name: "Osei-Danquah Family Office", description: "Private capital group looking for sustainable real estate an...", tags: ["PropTech", "Growth", "Debt"], avgTicket: "$500k", matchPercent: 89, status: "Verified", icon: "landmark" },
  { id: "6", name: "Retail West Africa Fund", description: "Specialized fund for retail supply chain optimization and...", tags: ["Logistics", "SME", "Seed"], avgTicket: "$125k", matchPercent: 65, status: "Low Activity", icon: "dollar" },
];
