...
const InvestorDashboardPage = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="font-display text-2xl font-semibold">Investor Dashboard</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <Card className="p-4 text-center">
          ...
          <p className="text-2xl font-semibold">{connections.size}</p>
        ...
        <Card className="p-4 text-center">
          ...
          <p className="text-2xl font-semibold">{pendingReceived.length}</p>
      ...
      <div>
        <h2 className="font-display text-lg font-semibold mb-4">Connection Requests</h2>
        <IncomingRequestsTab />
      </div>
    </div>
  );
