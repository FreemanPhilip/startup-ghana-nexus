...
const NetworkCard = ({ profile, isFollowing, connectionStatus, onToggleFollow, onConnect, onAcceptRequest, onMessage, onViewProfile }: NetworkCardProps) => {
  ...
  return (
    <div className="flex flex-col items-center rounded-2xl border border-border bg-card p-5 text-center transition-shadow hover:shadow-md cursor-pointer h-full" onClick={() => onViewProfile?.(profile.user_id)}>
